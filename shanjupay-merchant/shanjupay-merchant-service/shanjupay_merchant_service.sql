...
-- Records of app
-- ----------------------------
INSERT INTO `app` VALUES (1379360800460582913, '2bdb0dca50754af29bf2c86f6856be63', '这里输出应用名称', 1381136582077173761, 'string', 'string');
...
CREATE TABLE `merchant`  (
  ...
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1381136582077173762 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of merchant
-- ----------------------------
INSERT INTO `merchant` VALUES (1379330232364564482, '学生餐厅', '32321321312', '郑州梧桐创业大厦', '餐饮', '6272d44a‐19e4‐44a7‐a714‐58ffc7da8e45e.png', '6272d44a‐19e4‐44a7‐a714‐58ffc7da8e45e.png', '6272d44a‐19e4‐44a7‐a714‐58ffc7da8e45e.png', '张先生', '13877810600', '郑州梧桐街', '2', NULL);
INSERT INTO `merchant` VALUES (1381136582077173761, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'weiqiuke', '15678870532', NULL, '0', 2);
...
-- Records of staff
-- ----------------------------
INSERT INTO `staff` VALUES (1381136582702125057, 1381136582077173761, NULL, NULL, 'weiqiuke', '15678870532', 1381136582148476929, NULL, NULL);
...
-- Records of store
-- ----------------------------
INSERT INTO `store` VALUES (1381136582148476929, '根门店', NULL, 1381136582077173761, NULL, NULL, NULL);
...
-- ----------------------------
INSERT INTO `store_staff` VALUES (1381136582718902273, 1381136582148476929, 1381136582702125057);
