...
INSERT INTO `config_info` VALUES (2, 'merchant-application.yaml', 'SHANJUPAY_GROUP', 'server: \r\n  servlet: \r\n    context-path: /merchant \r\n    \r\nswagger: \r\n  enable: true\r\n\r\nsms: \r\n  url: \"http://localhost:56085/sailing\" \r\n  effectiveTime: 600\r\n\r\noss:\r\n  qiniu: \r\n    url: \"\" \r\n    accessKey: \"\" \r\n    secretKey: \"\" \r\n    bucket: \"\"\r\n\r\nshanjupay:\r\n  c2b:\r\n    subject: \"%s商品\"\r\n    body: \"向%s付款\"', '22643cac32fa521c082c890dd9fc7666', '2021-04-06 10:15:21', '2021-04-12 14:03:49', NULL, '127.0.0.1', '', '14d393fb-2d26-4e2a-b6d1-c152541749f7', 'null', 'null', 'null', 'yaml', 'null');
...
INSERT INTO `config_info` VALUES (30, 'spring-boot-freemarker.yaml', 'COMMON_GROUP', 'spring:\r\n  freemarker:\r\n    charset: UTF-8\r\n    request-context-attribute: rc\r\n    content-type: text/html\r\n    suffix: .html\r\n    enabled: true\r\n  resource:\r\n    add-mappings: false\r\n  mvc:\r\n    throw-exception-if-no-handler-found: true', '9a2c78f8b4601b69e3fa0214953e9035', '2021-04-12 14:57:25', '2021-04-12 14:57:25', NULL, '127.0.0.1', '', '14d393fb-2d26-4e2a-b6d1-c152541749f7', NULL, NULL, NULL, 'yaml', NULL);
INSERT INTO `config_info` VALUES (32, 'payment-agent-service.yaml', 'SHANJUPAY_GROUP', 'server:\r\n  servlet:\r\n    context-path: /payment-recevier', 'c37304f81cf0f910efee5a72a990db5c', '2021-04-12 17:11:12', '2021-04-12 17:11:12', NULL, '127.0.0.1', '', '14d393fb-2d26-4e2a-b6d1-c152541749f7', NULL, NULL, NULL, 'yaml', NULL);
INSERT INTO `config_info` VALUES (33, 'spring-boot-starter-rocketmq.yaml', 'COMMON_GROUP', 'rocketmq:\r\n  nameServer: 127.0.0.1:9876\r\n  producer:\r\n    group: PID_PAY_PRODUCER', '9823ba1a9aaf8378d8d08a6cedd5d10f', '2021-04-13 16:49:17', '2021-04-13 16:49:17', NULL, '127.0.0.1', '', '14d393fb-2d26-4e2a-b6d1-c152541749f7', NULL, NULL, NULL, 'yaml', NULL);
...
INSERT INTO `his_config_info` VALUES (22, 25, 'uaa-service.yaml', 'SHANJUPAY_GROUP', '', '# ??spring?boot?http.yaml??? \r\nserver:\r\n  servlet:\r\n    context?path: /uaa\r\n# ??spring?boot?starter?druid.yaml???\r\nspring: \r\n  datasource:\r\n    druid:\r\n      url: jdbc:mysql://127.0.0.1:3306/shanjupay_uaa?useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai&useSSL=false\r\n      username: root\r\n      password: root', 'c8eb2ee924cb280a510ddfffeeea3238', '2010-05-05 00:00:00', '2021-04-11 18:39:18', NULL, '127.0.0.1', 'U', '14d393fb-2d26-4e2a-b6d1-c152541749f7');
INSERT INTO `his_config_info` VALUES (20, 26, 'jwt.yaml', 'COMMON_GROUP', '', 'siging?key: shanju123', 'a43a4dc93e6465d64972cdd68a7c5925', '2010-05-05 00:00:00', '2021-04-11 18:42:05', NULL, '127.0.0.1', 'U', '14d393fb-2d26-4e2a-b6d1-c152541749f7');
INSERT INTO `his_config_info` VALUES (17, 27, 'transaction-service.yaml', 'SHANJUPAY_GROUP', '', 'server: \r\n  servlet: \r\n    context-path: /transaction \r\n\r\nspring: \r\n  datasource: \r\n    druid: \r\n      url: jdbc:mysql://127.0.0.1:3306/shanjupay_transaction?useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai&useSSL=false\r\n      username: root\r\n      password: root\r\n\r\nmybatis-plus:\r\n  typeAliasesPackage: com.shanjupay.transaction.entity\r\n  mapper-locations: classpath:com/shanjupay/*/mapper/*.xml', '28e1be09a2d59d67db42f81c3420ac0d', '2010-05-05 00:00:00', '2021-04-12 11:25:40', NULL, '127.0.0.1', 'U', '14d393fb-2d26-4e2a-b6d1-c152541749f7');
INSERT INTO `his_config_info` VALUES (17, 28, 'transaction-service.yaml', 'SHANJUPAY_GROUP', '', 'server: \r\n  servlet: \r\n    context-path: /transaction \r\n\r\nspring: \r\n  datasource: \r\n    druid: \r\n      url: jdbc:mysql://127.0.0.1:3306/shanjupay_transaction?useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai&useSSL=false\r\n      username: root\r\n      password: root\r\n\r\nmybatis-plus:\r\n  typeAliasesPackage: com.shanjupay.transaction.entity\r\n  mapper-locations: classpath:com/shanjupay/*/mapper/*.xml\r\n\r\nshanjupay:\r\n  payurl: \"http://127.0.0.1:56010/transaction/pay?entry/\"', 'dcafd2ff3bcabfff26caa51fc5bcccb6', '2010-05-05 00:00:00', '2021-04-12 11:25:52', NULL, '127.0.0.1', 'U', '14d393fb-2d26-4e2a-b6d1-c152541749f7');
INSERT INTO `his_config_info` VALUES (2, 29, 'merchant-application.yaml', 'SHANJUPAY_GROUP', '', 'server: \r\n  servlet: \r\n    context-path: /merchant \r\n    \r\nswagger: \r\n  enable: true\r\n\r\nsms: \r\n  url: \"http://localhost:56085/sailing\" \r\n  effectiveTime: 600\r\n\r\noss:\r\n  qiniu: \r\n    url: \"\" \r\n    accessKey: \"\" \r\n    secretKey: \"\" \r\n    bucket: \"\"', '95553082b2c0bba10f795760da6e4c34', '2010-05-05 00:00:00', '2021-04-12 11:50:47', NULL, '127.0.0.1', 'U', '14d393fb-2d26-4e2a-b6d1-c152541749f7');
INSERT INTO `his_config_info` VALUES (2, 30, 'merchant-application.yaml', 'SHANJUPAY_GROUP', '', 'server: \r\n  servlet: \r\n    context-path: /merchant \r\n    \r\nswagger: \r\n  enable: true\r\n\r\nsms: \r\n  url: \"http://localhost:56085/sailing\" \r\n  effectiveTime: 600\r\n\r\noss:\r\n  qiniu: \r\n    url: \"\" \r\n    accessKey: \"\" \r\n    secretKey: \"\" \r\n    bucket: \"\"\r\n\r\nshanjupay:\r\n  c2b:\r\n    subject: \"%s??\"\r\n    body: \"?%s??\"', '76d6d8d7608e51067349d0ded115afef', '2010-05-05 00:00:00', '2021-04-12 14:03:49', NULL, '127.0.0.1', 'U', '14d393fb-2d26-4e2a-b6d1-c152541749f7');
INSERT INTO `his_config_info` VALUES (0, 31, 'spring-boot-freemarker.yaml', 'COMMON_GROUP', '', 'spring:\r\n  freemarker:\r\n    charset: UTF-8\r\n    request-context-attribute: rc\r\n    content-type: text/html\r\n    suffix: .html\r\n    enabled: true\r\n  resource:\r\n    add-mappings: false\r\n  mvc:\r\n    throw-exception-if-no-handler-found: true', '9a2c78f8b4601b69e3fa0214953e9035', '2010-05-05 00:00:00', '2021-04-12 14:57:25', NULL, '127.0.0.1', 'I', '14d393fb-2d26-4e2a-b6d1-c152541749f7');
INSERT INTO `his_config_info` VALUES (21, 32, 'gateway-service.yaml', 'SHANJUPAY_GROUP', '', '#????\r\nzuul:\r\n  retryable: true\r\n  add-host-header: true\r\n  ignoredServices: \"*\"\r\n  sensitiveHeaders: \"*\"\r\n  routes:\r\n    operation-application:\r\n      path: /operation/**\r\n      stripPrefix: false\r\n    merchant-application:\r\n      path: /merchant/**\r\n      stripPrefix: false\r\n    uaa-service: \r\n      path: /uaa/**\r\n      stripPrefix: false\r\n\r\nfeign:\r\n  hystrix:\r\n    enabled: true\r\n  compression:\r\n    request:\r\n      enabled: true # ????GZIP??\r\n      mime-types: [\"text/xml\",\"application/xml\",\"application/json\"] # ???????MIME TYPE\r\n      min-request-size: 2048 # ???????????\r\n    response:\r\n      enabled: true # ????GZIP??\r\n\r\nhystrix:\r\n  command:\r\n    default:\r\n      execution:\r\n        isolation:\r\n          thread:\r\n            timeoutInMilliseconds: 93000  # ????????  default 1000\r\n        timeout:\r\n          enabled: true # ???????? default true\r\n\r\nribbon:\r\n  nacos:\r\n    enabled: true # ???????\r\n  ConnectTimeout: 3000 # ???????? default 2000\r\n  ReadTimeout: 20000    # ????????  default 5000\r\n  OkToRetryOnAllOperations: false # ????????????  default false\r\n  MaxAutoRetriesNextServer: 1    # ?????????  default 1\r\n  MaxAutoRetries: 1     # ?????????? default 0', '33e03e0ddcd3209093d1557dcf50699e', '2010-05-05 00:00:00', '2021-04-12 16:32:14', NULL, '127.0.0.1', 'U', '14d393fb-2d26-4e2a-b6d1-c152541749f7');
INSERT INTO `his_config_info` VALUES (0, 33, 'payment-agent-service.yaml', 'SHANJUPAY_GROUP', '', 'server:\r\n  servlet:\r\n    context-path: /payment-recevier', 'c37304f81cf0f910efee5a72a990db5c', '2010-05-05 00:00:00', '2021-04-12 17:11:12', NULL, '127.0.0.1', 'I', '14d393fb-2d26-4e2a-b6d1-c152541749f7');
INSERT INTO `his_config_info` VALUES (0, 34, 'spring-boot-starter-rocketmq.yaml', 'COMMON_GROUP', '', 'rocketmq:\r\n  nameServer: 127.0.0.1:9876\r\n  producer:\r\n    group: PID_PAY_PRODUCER', '9823ba1a9aaf8378d8d08a6cedd5d10f', '2010-05-05 00:00:00', '2021-04-13 16:49:17', NULL, '127.0.0.1', 'I', '14d393fb-2d26-4e2a-b6d1-c152541749f7');
INSERT INTO `his_config_info` VALUES (17, 35, 'transaction-service.yaml', 'SHANJUPAY_GROUP', '', 'server: \r\n  servlet: \r\n    context-path: /transaction \r\n\r\nspring: \r\n  datasource: \r\n    druid: \r\n      url: jdbc:mysql://127.0.0.1:3306/shanjupay_transaction?useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai&useSSL=false\r\n      username: root\r\n      password: root\r\n\r\nmybatis-plus:\r\n  typeAliasesPackage: com.shanjupay.transaction.entity\r\n  mapper-locations: classpath:com/shanjupay/*/mapper/*.xml\r\n\r\nshanjupay:\r\n  payurl: \"http://127.0.0.1:56010/transaction/pay-entry/\"', 'a4a3cf072e27b4ac7c5cd778a6a59332', '2010-05-05 00:00:00', '2021-04-14 10:02:16', NULL, '127.0.0.1', 'U', '14d393fb-2d26-4e2a-b6d1-c152541749f7');
INSERT INTO `his_config_info` VALUES (17, 36, 'transaction-service.yaml', 'SHANJUPAY_GROUP', '', 'server: \r\n  servlet: \r\n    context-path: /transaction \r\n\r\nspring: \r\n  datasource: \r\n    druid: \r\n      url: jdbc:mysql://127.0.0.1:3306/shanjupay_transaction?useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai&useSSL=false\r\n      username: root\r\n      password: root\r\n\r\nmybatis-plus:\r\n  typeAliasesPackage: com.shanjupay.transaction.entity\r\n  mapper-locations: classpath:com/shanjupay/*/mapper/*.xml\r\n\r\nshanjupay:\r\n  payurl: \"http://127.0.0.1:56010/transaction/pay-entry/\"\r\n\r\nweixin:\r\n  oauth2RequestUrl: \"https://open.weixin.qq.com/connect/oauth2/authorize\"\r\n  oauth2CodeReturnUrl: \"http://xfc.nat300.top/transaction/wx?oauth?code?return\"\r\n  oauth2Token: \"https://api.weixin.qq.com/sns/oauth2/access_token\"', '4185543c43ae94414aefd52dc442c86b', '2010-05-05 00:00:00', '2021-04-14 10:02:43', NULL, '127.0.0.1', 'U', '14d393fb-2d26-4e2a-b6d1-c152541749f7');
