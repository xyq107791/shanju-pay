...
-- Records of account
-- ----------------------------
INSERT INTO `account` VALUES (1, 'weiqiuke', '15678870532', 'd6a41f6437b4249411a1d36ac83180a2', 'k69Sv');
INSERT INTO `account` VALUES (4, 'zhourunfa', '13800000000', 'f6b8607959655252c430ffe7a7816f5b', 'j8i20');
...
CREATE TABLE `account_role`  (
  ...
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '账号-角色关系' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of account_role
-- ----------------------------
INSERT INTO `account_role` VALUES (1, 'weiqiuke', 'r_001', 2);
INSERT INTO `account_role` VALUES (2, 'weiqiuke', 'r_002', 2);
INSERT INTO `account_role` VALUES (3, 'zhourunfa', 'r_001', 5);
INSERT INTO `account_role` VALUES (4, 'zhourunfa', 'r_002', 5);
...
CREATE TABLE `authorization_privilege_group`  (
  ...
  `NAME` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '权限组名称',
  PRIMARY KEY (`ID`) USING BTREE
...
) ENGINE = InnoDB AUTO_INCREMENT = 54 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '角色信息' ROW_FORMAT = Dynamic;
...
INSERT INTO `authorization_role` VALUES (52, '商户管理员', 'r_001', 5);
INSERT INTO `authorization_role` VALUES (53, '商户门店收银员', 'r_002', 5);
...
) ENGINE = InnoDB AUTO_INCREMENT = 558 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '角色-权限关系' ROW_FORMAT = Dynamic;
...
CREATE TABLE `bundle`  (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `NAME` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '套餐名称',
  `CODE` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '套餐编码',
  `TENANT_TYPE_CODE` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '租户类型编码',
  `ABILITY` longtext CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '套餐包含功能描述,JSON格式的角色与权限',
  ...
  `COMMENT` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '套餐说明',
...
CREATE TABLE `resource_application`  (
  ...
  `CODE` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '应用编码',
  `TENANT_ID` bigint(20) DEFAULT NULL COMMENT '租户id',
  PRIMARY KEY (`ID`) USING BTREE
...
CREATE TABLE `resource_button`  (
  ...
  `URL` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '链接url',
  `ICON` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '图标',
  `SORT` int(11) NOT NULL COMMENT '排序',
  `COMMENT` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '说明',
  `STATUS` int(11) NOT NULL COMMENT '状态',
  `APPLICATION_CODE` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '所属应用编码',
  `PRIVILEGE_CODE` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '绑定权限',
  `PCODE` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '用于鉴权',
  PRIMARY KEY (`ID`) USING BTREE
...
CREATE TABLE `tenant`  (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `NAME` varchar(512) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '租户名称',
  `TENANT_TYPE_CODE` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '租户类型编码',
  `BUNDLE_CODE` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '购买套餐编码',
  PRIMARY KEY (`ID`) USING BTREE
...
INSERT INTO `tenant` VALUES (2, 'weiqiuke_2h43r5', 'shanju-merchant', 'shanju-merchant');
INSERT INTO `tenant` VALUES (5, 'zhourunfa_2jXJ9C', 'shanju-merchant', 'shanju-merchant');
...
INSERT INTO `tenant_account` VALUES (2, 5, 4, 1);
...
CREATE TABLE `tenant_type`  (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `NAME` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '租户类型名称',
  `CODE` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '租户类型编码',
  PRIMARY KEY (`ID`) USING BTREE
